...
var BrowserManager = /** @class */ (function () {
    function BrowserManager(config) {
        ...
        this.config = __assign({ headless: true }, config);
        this.browser = null;
        this.pages = new Set();
    }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, puppeteer.launch(this.config)];
                    case 1:
                        _a.browser = _b.sent();
                        return [2 /*return*/];
                }
    ...
    BrowserManager.prototype.createPage = function () {
        return __awaiter(this, void 0, void 0, function () {
            var page;
    ...
    BrowserManager.prototype.setupPageDefaults = function (page) {
        var _this = this;
        // 대화상자 처리 등 기본 설정
    ...
    BrowserManager.prototype.closePage = function (page) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.pages.has(page)) return [3 /*break*/, 2];
