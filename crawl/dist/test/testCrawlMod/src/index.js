...
// src/index.js
var Crawler = require('./crawler/Crawler').Crawler;
var config = require('./config/config');
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var targetUrl, crawler, results, urlChanges;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    urlChanges = results.filter(function (r) { return r.urlChanged && r.detectedUrl; });
