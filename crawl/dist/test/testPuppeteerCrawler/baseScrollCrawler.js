...
function extractAndExecuteScripts(url) {
    return __awaiter(this, void 0, void 0, function () {
        // 스크롤하면서 요소 수집 함수
        function scrollAndCollectElements() {
            return __awaiter(this, void 0, void 0, function () {
                var collectedElements, lastHeight, scrollCount, maxScrolls, newHeight, newElements, addedScripts, addedLinks, addedOnclicks;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, page_1.evaluate('document.body.scrollHeight')];
                        case 1:
                            lastHeight = _a.sent();
                            scrollCount = 0;
                            maxScrolls = 15;
                            _a.label = 2;
                        case 2:
                            if (!(scrollCount < maxScrolls)) return [3 /*break*/, 7];
                            scrollCount++;
                            console.log("\uC2A4\uD06C\uB864 ".concat(scrollCount, "/").concat(maxScrolls, " \uC218\uD589 \uC911..."));
                            // 페이지를 스크롤하여 새로운 콘텐츠 로드
                            return [4 /*yield*/, page_1.evaluate('window.scrollTo(0, document.body.scrollHeight)')];
                        case 3:
                            // 페이지를 스크롤하여 새로운 콘텐츠 로드
                            _a.sent();
                            // 콘텐츠가 로드될 때까지 대기
                        ...
                        case 6:
                            newElements = _a.sent();
                            addedScripts = addUniqueElements(collectedElements.scripts, newElements.scripts, 'hash');
                            addedLinks = addUniqueElements(collectedElements.links, newElements.links, 'hash');
                            addedOnclicks = addUniqueElements(collectedElements.onclicks, newElements.onclicks, 'hash');
                            console.log("\uC2A4\uD06C\uB864 ".concat(scrollCount, "\uC5D0\uC11C \uBC1C\uACAC: \uC0C8 \uC2A4\uD06C\uB9BD\uD2B8 ").concat(addedScripts, "\uAC1C, \uC0C8 \uB9C1\uD06C ").concat(addedLinks, "\uAC1C, \uC0C8 onclick ").concat(addedOnclicks, "\uAC1C"));
                            ...
                            return [3 /*break*/, 2];
                        case 7:
                            console.log("=== \uC2A4\uD06C\uB864 \uC644\uB8CC: \uCD1D ".concat(collectedElements.scripts.length, "\uAC1C\uC758 \uC2A4\uD06C\uB9BD\uD2B8, ").concat(collectedElements.links.length, "\uAC1C\uC758 \uB9C1\uD06C, ").concat(collectedElements.onclicks.length, "\uAC1C\uC758 onclick \uC694\uC18C \uC218\uC9D1\uB428 ==="));
                            // 중복 체크용 해시 속성 제거
                            collectedElements.scripts.forEach(function (item) { return delete item.hash; });
                            collectedElements.links.forEach(function (item) { return delete item.hash; });
                            collectedElements.onclicks.forEach(function (item) { return delete item.hash; });
                            return [2 /*return*/, collectedElements];
                    }
                });
            });
        }
        ...
        function addUniqueElements(targetArray, newElements, hashProperty) {
            var existingHashes = new Set(targetArray.map(function (item) { return item[hashProperty]; }));
            var added = 0;
        ...
        var browser, result, allUrls, page_1, currentUrl, pageData, inlineScripts, _loop_1, i, _loop_2, i, urlArray, urlData, error_1;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    page_1.on('dialog', function (dialog) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                    ...
                    console.log("".concat(url, " \uB85C\uB4DC \uC911..."));
                    return [4 /*yield*/, page_1.goto(url, {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, page_1.waitForTimeout(5000)];
                case 5:
                    // 추가 로딩 시간을 위해 대기 (느린 사이트 대응)
                    _a.sent();
                    console.log("\uD398\uC774\uC9C0 \uB85C\uB4DC \uC644\uB8CC: ".concat(url));
                    currentUrl = page_1.url();
                    console.log("\uD604\uC7AC URL: ".concat(currentUrl));
                    // 현재 URL이 초기 URL과 다르다면 추가
                    if (currentUrl !== url) {
                        allUrls.add(currentUrl);
                    }
                    return [4 /*yield*/, scrollAndCollectElements()];
                case 6:
                    pageData = _a.sent();
                    console.log("\uC218\uC9D1 \uC644\uB8CC: ".concat(pageData.scripts.length, "\uAC1C\uC758 \uC2A4\uD06C\uB9BD\uD2B8, ").concat(pageData.links.length, "\uAC1C\uC758 \uB9C1\uD06C, ").concat(pageData.onclicks.length, "\uAC1C\uC758 onclick \uC694\uC18C\uB97C \uCC3E\uC558\uC2B5\uB2C8\uB2E4."));
                    // 페이지 내 모든 링크 URL 수집
                    ...
                    fs.writeFileSync('scroll_collected_elements.json', JSON.stringify({
                        ...
                        scripts: pageData.scripts.map(function (s) { return ({
                            type: s.type,
                            src: s.src,
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 3:
                                    ...
                                    return [4 /*yield*/, scriptPage.goto(currentUrl, {
                                            waitUntil: 'networkidle2',
                                ...
                                case 4:
                                    ...
                                    return [4 /*yield*/, scriptPage.waitForTimeout(3000)];
                                case 5:
                                    // 페이지가 완전히 로드될 때까지 추가 대기
                                    _b.sent();
                                    // 콘솔 로그를 가로채서 출력
                                ...
                                case 7:
                                    ...
                                    return [4 /*yield*/, scriptPage.waitForTimeout(5000)];
                                case 8:
                                    // URL 변경 감지를 위해 더 오래 대기 (5초)
                                    _b.sent();
                                    return [4 /*yield*/, scriptPage.url()];
                                case 9:
                                    ...
                                    // 이 페이지는 닫고 메모리를 절약
                                    return [4 /*yield*/, scriptPage.close()];
                                case 10:
                                    // 이 페이지는 닫고 메모리를 절약
                                    _b.sent();
                                    return [3 /*break*/, 12];
                ...
                case 10:
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                ...
                                case 3:
                                    ...
                                    _c.sent();
                                    // 페이지 로드 타임아웃 증가 및 로딩 후 추가 대기
                                    return [4 /*yield*/, onclickPage.goto(currentUrl, {
                                            waitUntil: 'networkidle2',
                                            timeout: 60000
                                        })];
                                case 4:
                                    ...
                                    _c.sent();
                                    // 페이지가 완전히 로드될 때까지 추가 대기
                                    return [4 /*yield*/, onclickPage.waitForTimeout(3000)];
                                case 5:
                                    // 페이지가 완전히 로드될 때까지 추가 대기
                                    _c.sent();
                                    // 콘솔 로그를 가로채서 출력
                                ...
                                case 7:
                                    ...
                                    return [4 /*yield*/, onclickPage.waitForTimeout(5000)];
                                case 8:
                                    // 실행 후 URL 확인하여 변경 감지를 위한 긴 대기
                                    _c.sent();
                                    return [4 /*yield*/, onclickPage.url()];
                    ...
                    _a.label = 11;
                case 11:
                    if (!(i < pageData.onclicks.length)) return [3 /*break*/, 14];
                ...
                case 14:
                    ...
                    urlArray = Array.from(allUrls).filter(function (url) { return url && typeof url === 'string' && url.startsWith('http'); });
                    urlData = {
                        baseUrl: url,
                    ...
                    console.log("\uCD1D ".concat(urlArray.length, "\uAC1C\uC758 URL\uC744 total_url.json \uD30C\uC77C\uC5D0 \uC800\uC7A5\uD588\uC2B5\uB2C8\uB2E4."));
