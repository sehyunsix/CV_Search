...
describe('삼성 생명 커리어 채용 페이지 크롤링 테스트', function () {
    var manager;
    var page;
    var targetUrl = 'https://samsunglifeservice.recruiter.co.kr/';
    var allowedDomains = ['samsunglifeservice.recruiter.co.kr'];
    ...
    afterEach(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(manager && manager.browser)) return [3 /*break*/, 3];
                    return [4 /*yield*/, manager.browser.pages().catch(function (err) {
                ...
                case 1:
                    ...
                    console.log("\uB0A8\uC544\uC788\uB294 ".concat(pages.length, "\uAC1C \uD398\uC774\uC9C0 \uC815\uB9AC \uC911..."));
                    // 각 페이지 닫기 시도
                    return [4 /*yield*/, Promise.all(pages.map(function (browserPage) {
                            return browserPage.close().catch(function (err) {
                                return console.warn('브라우저 페이지 닫기 오류:', err);
                            });
                        }))];
                case 2:
                    // 각 페이지 닫기 시도
