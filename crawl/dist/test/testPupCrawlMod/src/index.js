...
var CrawlerManager = require('./lib/crawler-manager').CrawlerManager;
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var targetUrl, crawler, results, urlChanges, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    targetUrl = process.argv[2] || 'https://recruit.navercorp.com/rcrt/list.do';
                ...
                case 3:
                    ...
                    process.exit(1);
                    return [3 /*break*/, 6];
                case 4: return [4 /*yield*/, crawler.close()];
                case 5:
                    _a.sent();
                    return [7 /*endfinally*/];
