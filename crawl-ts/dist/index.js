...
const MongoDbUrlManager_1 = require("./url/MongoDbUrlManager");
...
function createCrawler(options = {}) {
    ...
    const urlManager = new MongoDbUrlManager_1.MongoDbUrlManager({
        strategy,
        specificDomain
    });
    ...
    return new WebCrawler_1.WebCrawler({
        ...
        urlManager,
        dbConnector,
        delayBetweenRequests: config_1.default.CRAWLER.DELAY_BETWEEN_REQUESTS,
