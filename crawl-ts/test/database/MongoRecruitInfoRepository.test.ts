...
describe('MongoRecruitInfoRepository', () => {
  ...
  describe('createRecruitInfo', () => {
    test('should create new recruit info successfully', async () => {
      // Mock data
      const recruitInfo: ICacheDbRecruitInfo = {
      ...
      (mockRecruitInfoModel.create as jest.Mock).mockResolvedValue(createdRecord);
    ...
    test('should throw error when create operation fails', async () => {
      ...
      (mockRecruitInfoModel.create as jest.Mock).mockRejectedValue(dbError);
  ...
  describe('updateRecruitInfo', () => {
    test('should update recruit info successfully', async () => {
      ...
      (mockRecruitInfoModel.findByIdAndUpdate as jest.Mock).mockReturnValue({
        exec: mockExec
      });
      ...
      expect(mockRecruitInfoModel.findByIdAndUpdate).toHaveBeenCalledWith(
        id,
        recruitInfo,
        { new: true }
      );
  ...
  describe('findByUrl', () => {
    test('should return recruit info when url exists', async () => {
      ...
      (mockRecruitInfoModel.findOne as jest.Mock).mockReturnValue({
        exec: mockExec
      });
